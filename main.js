...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initFecthBitcoin; });\nfunction initFecthBitcoin() {\n  fetch('https://blockchain.info/ticker')\n    .then((response) => response.json())\n    .then((bitcoin) => {\n      const btcPreco = document.querySelector('.btc-preco');\n      btcPreco.innerText = (50 / bitcoin.BRL.sell).toFixed(4);\n    }).catch((erro) => console.log(Error(erro)));\n}\n\n\n//# sourceURL=webpack:///./js/modules/fetch-bitcoin.js?");
